...
gdt_entry_t gdt[GDT_COUNT] = {
    ...
    [GDT_IDX_CODE_0] = 
        {
            .limit_15_0 = GDT_LIMIT_LOW(GDT_LIMIT_BYTES(GDT_LIMIT_4KIB(FLAT_SEGM_SIZE))),
            .base_15_0 = 0x0000,
            .base_23_16 = 0x00,
            ...
            .dpl = 0x00,
            .p = 0x1,
            .limit_19_16 = GDT_LIMIT_HIGH(GDT_LIMIT_BYTES(GDT_LIMIT_4KIB(FLAT_SEGM_SIZE))),
            .avl = 0x0,
            .l = 0x0,
            .db = 0x1,
            .g = 0x1,
