        ...
        if (j == 0) {
            for (size_t i = 0; i < 10; i++) {
                if (it->arreglo[i] != ((100 - i) * 2) + 45) {
                    printf("60. Fallo en agregar_al_final\n");
                    res = false;
                    break;
                }
            }
...
void test_lista_contiene_elemento(void) {
    ...
    if (result1 != 1) {
        printf("1Fallo en lista_contiene_elemento\n");
        exit(1);
    }
    int result2 = lista_contiene_elemento(mi_lista, 2);
    if (result2 != 1) {
        printf("2Fallo en lista_contiene_elemento\n");
        exit(1);
    }
    int result3 = lista_contiene_elemento(mi_lista, 100);
    if (result3 != 0) {
        printf("3Fallo en lista_contiene_elemento\n");
        exit(1);
    }
    int result4 = lista_contiene_elemento(mi_lista, 88);
    if (result4 != 0) {
        printf("4Fallo en lista_contiene_elemento\n");
        exit(1);
    }
    int result5 = lista_contiene_elemento(mi_lista, 99);
    if (result5 != 0) {
        printf("5Fallo en lista_contiene_elemento\n");
        exit(1);
    }
    int result6 = lista_contiene_elemento(mi_lista, 56);
    if (result6 != 1) {
        printf("6Fallo en lista_contiene_elemento\n");
        exit(1);
    }
