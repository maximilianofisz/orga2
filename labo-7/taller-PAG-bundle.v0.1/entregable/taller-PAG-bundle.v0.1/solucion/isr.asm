...
_isr33:
    ...
    in al, 0x60                 ; Leer el puerto del teclado
    
    push eax
    call process_scancode       ; Procesar el scancode leído
    pop eax

    call pic_finish1            ; Indicar al PIC que la interrupción ha sido manejada
...
_isr14:
    ...
    ; agrego todo el codigo del exception handling default
    call kernel_exception
    add esp, 10*4
    popad
    xchg bx, bx
    ...
    .fin:
	popad
    add esp, 4 ; aca estoy medio en duda, entiendo que tengo que sumarle al esp cuanto sea para que tenga su posicion el eip
                ; sino, me da gp fault
	iret
